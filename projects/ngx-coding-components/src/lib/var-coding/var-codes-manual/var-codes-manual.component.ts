...
@Component({
    ...
    standalone: true,
    imports: [CodesTitleComponent, MatCheckbox, NgIf, NgFor, CodeHeaderComponent, MatTooltip, CodeInstructionComponent, MatIconButton, MatIcon, MatButton, TranslateModule, HasRulePipe]
})
