  ...
  template: `
    ...
    <mat-card [style.padding-left.px]="12" [style.height.%]="100">
        ...
        <div class="fx-row-space-between-center">
          <div class="fx-row-start-center">
            ...
            <mat-icon
              [style.color]="'red'"
              [matTooltip]="
                'manual-instruction.code.error-residual-auto' | translate
              "
            >
              error
            </mat-icon>
            ...
            <mat-icon
              [style.color]="'red'"
              [matTooltip]="
                'manual-instruction.code.error-intended-incomplete' | translate
              "
            >
              error
            </mat-icon>
      ...
      <mat-card-content [style.overflow-x]="'auto'">
        <div
          [innerHTML]="
            code ? getSanitizedText(code.manualInstruction || '') : null
          "
        ></div>
      </mat-card-content>
    </mat-card>
      ...
      const dialogRef = this.editTextDialog.open(RichTextEditDialogComponent, {
        ...
        data: {
          title: this.translateService.instant(
            'manual-instruction.code.prompt-edit'
          ),
